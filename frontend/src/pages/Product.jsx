    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex-1'>
        ...
        <div className='flex items-center gap-1 mt-2'>
          ...
          <p className='mt text-3xl forn-medium'>{currency}{productData.price}</p>
          ...
          <button onClick={()=>addToCart(productId,size)} className='bg-black text-white px-8 py-3 text-sm active:bg-gray-700'>ADD TO CARD</button>
              <hr className='mt-8 sm:w-4/5'></hr>
              <div className='text-am text-gray-500 mt-5 flex flex-col gap-1'>
